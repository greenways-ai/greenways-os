...
The macOS build phase compiles and embeds `greenways-desktop-bridge` into the app bundle. For focused Dart development, `GREENWAYS_DESKTOP_BRIDGE` may name a locally built companion executable; the setting is not exposed in the UI or persisted.
