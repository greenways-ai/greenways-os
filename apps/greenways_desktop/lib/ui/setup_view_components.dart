          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (component.version != null || component.publicId != null) ...[
                  const SizedBox(height: 6),
                  Text(
                    [component.version, component.publicId]
                        .whereType<String>()
                        .join(' · '),
                    maxLines: 2,
...
String _setupStateDescription(DesktopSetupSnapshot snapshot) =>
    switch (snapshot.state) {
      DesktopSetupState.notInspected =>
        'Check the fixed Greenways home, daemon, Desktop access, identity, and browser companion boundaries.',
      ...
      DesktopSetupState.identityOptional =>
        'The daemon and Desktop access are ready; public identity may be created later.',
