  ...
  Widget build(BuildContext context) {
    return KeyedSubtree(
      ...
      child: _SetupPageFrame(
        ...
        subtitle:
            'Inspect the fixed local components before any installation or repair authority is enabled.',
        children: [
          _SetupSummary(
            snapshot: snapshot,
  ...
  Widget build(BuildContext context) {
    ...
    final actions = ready
        ...
        : FilledButton.icon(
            ...
            label: Text(snapshot.inspected ? 'Check again' : 'Check local components'),
          );
    return Card(
      child: Padding(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 7),
                  const Text(
                    'This page uses fixed Greenways locations and returns only public component states. It does not change permissions, issue credentials, create identity, or install browser software.',
                  ),
                ],
              ),
            ),
