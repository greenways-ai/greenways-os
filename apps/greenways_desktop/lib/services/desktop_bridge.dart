...
abstract interface class DesktopBridge {
  ...
  Future<DesktopSetupSnapshot> inspectSetup();
  Future<void> close();
}
...
final class ProcessDesktopBridge implements DesktopBridge {
  ...
  final Map<String, Completer<DesktopConnectionSnapshot>>
  _pendingConnections = {};
  ...
  @override
  Future<DesktopSetupSnapshot> inspectSetup() => _sendSetup('inspect');
  ...
  void _handleLine(String line) {
    try {
      ...
      throw const FormatException('Desktop bridge response protocol is unknown.');
    } on Object {
      _failPending(
